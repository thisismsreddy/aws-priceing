    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="alert alert-info">
          Note: we are only considering EBS volumes here. Newer clouds (dc1-cdl-osp4, dc1-osp5, dc2-osp5) use NVMe storage, so take these results with a grain of salt.
        </div>
        <form method="post"
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="cloud"
                     name="cloud" value="{{ default_cloud }}" required>
            </div>
    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        <ul class="list-inline mb-0">
          ...
          <li class="list-inline-item"><strong>Monthly Cost (On-Demand):</strong> ${{ summary.monthly_cost | round(2) }}</li>
        </ul>
      </div>
    </div>
